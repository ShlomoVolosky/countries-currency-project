...
dag = DAG(
    'countries_currency_processing',
    default_args=default_args,
    description='Process countries and currency data',
    schedule=None,
    catchup=False,
    tags=['countries', 'currency', 'exchange'],
)
...
setup_db_task >> process_countries_task >> process_currencies_task >> cleanup_db_task
